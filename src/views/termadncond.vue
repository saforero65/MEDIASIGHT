    ...
    <div class="container todo">
      ...
      <div class="contenido overflow-auto" style="height: 70vh">
        ...
        <p>
          ...
          MEDIASIGHT usa y protege la información que es proporcionada por sus
        ...
        <p>
          MEDIASIGHT está altamente comprometido para cumplir con el compromiso
        ...
        <p>
          ...
          respecto al tráfico web. Otra función que tienen las cookies es que
        ...
        <p>
          MEDIASIGHT Se reserva el derecho de cambiar los términos de la
          presente Política de Privacidad en cualquier momento.
        </p>
        <p>
          Estas terminos y condiciones se han generado en
          <a
            href="http://plantillaterminosycondicionestiendaonline.com/"
            target="_blank"
            >plantillaterminosycondicionestiendaonline.com</a
          >.<br />
        </p>
      </div>
    </div>
