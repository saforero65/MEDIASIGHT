    ...
    <footer class="position-absolute">
      ...
      <div>
        ...
        <div v-if ="mouse" class="Info_Footer">
          ...
          <div class="clic">
            <p>
              Use el scroll del mouse para hacer zoom en la habitación
            </p>
              ...
              <div v-if="showC">
                <div class="about">
                  <h3>Ingeniería en Multimedia</h3>
                    <div class="cont_info">
                      <a href="https://www.umng.edu.co/documents/20127/432682/Ing+en+Multimedia+copia.pdf/027fbe6e-b046-00c1-4a97-81a520f299ae?t=1589289836585" target="_blank">
                      <img src= "@/assets/img/icons/folleto.svg" alt= "Folleto"/>
                      <h4>Folleto del programa</h4></a>
                    </div>
                    <div class="cont_info">
                      <a href="https://www.umng.edu.co/web/guest/programas/pregrados/ingenieria-multimedia" target="_blank">
                      <img src= "@/assets/img/icons/info_general.svg" alt= "Informacion general"/>
                      <h4>Información General</h4></a>
                    </div>
                    <div class="cont_info">
                      <a href="https://www.umng.edu.co/documents/20127/463311/Plan+de+estudios+IngMultimedia.pdf/280c5b1f-3d57-2598-86a4-81b7be79300f?t=1574191474428" target="_blank">
                      <img src= "@/assets/img/icons/plan_estudios.svg" alt= "Plan de estudios"/>
